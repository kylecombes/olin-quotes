...
export default (props: Props) => {
  const classNames = 'like-heart ' + (props.className || '') + (props.liked ? ' liked' : '');
  const tooltipText = props.liked ? 'Unlike' : 'Like';
  return (
    <div className={classNames} title={tooltipText}>
      <svg className={classNames} onClick={props.onClick} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 54.2 47.6">
